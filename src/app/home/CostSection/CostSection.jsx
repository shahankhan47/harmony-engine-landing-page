      ...
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          <div className={styles.column}>
            <h3 className={styles.subTitle}>Visible costs</h3>
            ...
            <div className={styles.stack}>
              ...
              <div className={styles.card}>
                ...
                <p>
                  Scope and timing slip because hidden dependencies and
                  coupling only show up after work begins.
                </p>
              </div>
              ...
              <div className={styles.card}>
                ...
                <p>
                  High-stakes projects drag because no one feels confident
                  enough to commit.
                </p>
              </div>
            </div>
          ...
          <div className={styles.column}>
            <h3 className={styles.subTitle}>Hidden costs</h3>
